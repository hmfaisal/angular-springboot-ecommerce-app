...
@Component({
  selector: 'app-product-by-low',
  templateUrl: './product-by-low.component.html',
  styleUrls: ['./product-by-low.component.scss']
})
export class ProductByLowComponent implements OnInit, OnDestroy {
  ...
  getProducts(page, country): void {
    ...
    this.subscription.add(this.productService.getByPriceLow(page, country)
      .subscribe(data => {
        this.products = data;
